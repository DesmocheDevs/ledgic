...
export default function ClientesPage() {
  ...
  const [activeSection, setActiveSection] = useState<ActiveSection>('clientes');
  ...
  if (authLoading) {
    return <AuthLoading message="Cargando clientes..." />;
  }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                <div className="text-center py-8">
                  ...
                  <h4 className="text-lg font-medium text-gray-900 mb-2">Módulo de Clientes</h4>
